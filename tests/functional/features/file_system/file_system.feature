...
Feature: File system extension
    ...
    Scenario: Checking file content equals/matches something
        Given I set cwd to tests/functional/features/file_system/files
        Then file test_dir/content.txt content should match content.txt content\n

    Scenario: Checking file content does not equal something
        Given I set cwd to tests/functional/features/file_system/files
        Then file test_dir/content.txt content should not equal crap

    Scenario: Checking file content contains something
        Given I set cwd to tests/functional/features/file_system/files
        Then file test.json content should contain "testing": "for sure!"

    Scenario: Checking file content does not contain something
        Given I set cwd to tests/functional/features/file_system/files
        Then file test.json content should not contain "something else"
